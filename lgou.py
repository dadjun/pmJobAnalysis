...
def get_json(url, page, lang_name):
    ...
    headers = {
        ...
        'x-anit-forge-code':'0',
        'x-anit-forge-token': 'None',
        #':path':'/jobs/positionAjax.json?city=%E6%B7%B1%E5%9C%B3&needAddtionalResult=false',
    ...
    for i in list_con:
        ...
        info.append(i.get('latitude','无'))
        info.append(i.get('longitude', '无'))
        info.append(",".join(i.get('companyLabelList', '无')))
...
def main():
    ...
    for i in ['深圳']:   # 五个城市
        ...
        ws1 = wb.active
        ws1.title = lang_name
        #cityutf8 = parse.quote(i)
        url = 'https://www.lagou.com/jobs/positionAjax.json?city={}&needAddtionalResult=false'.format(i)
        print(url)
        while page < 100:   # 每个城市30页信息
